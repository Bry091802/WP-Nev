...
<?php
  ...
  if(get_field('discover_bg')):?>

    <section class="watchVideos" style="background: url('<?php the_field('discover_bg') ?>'); 
    background-attachment:fixed; background-repeat:no-repeat; background-size:cover; background-position:center;">
        <?php endif; ?>
        ...
        <div class="watchVideos__wrapper">
          <div class="watchVideos__content">
            ...
            <ul class="d--flex align--center">
              <li><img src="<?php the_field('discover_icon') ?>" alt="" /></li>
              <li><h5><?php the_field('discover_icon_text') ?></h5></li>
            </ul>
            <p>
          ...
          <div class="videos d--flex">
            <iframe
              width="300"
              height="150"
              src="<?php the_field('discover_vid') ?>"
            ...
            <iframe
              width="300"
              height="150"
              src="<?php the_field('discover_vid2') ?>"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
